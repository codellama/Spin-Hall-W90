...
!                if(berry_curv_unit=='bohr2') vdum=vdum/bohr**2
  ...
  !                                                                       !
  ! Overall the sbc from here is missing a factor of hbar/2 which will    !
  ! be taken care of in berry_main                                        !
  !=======================================================================!
   ...
   ! However SS_R stores the Pauli marix not spin matrix 
   ! factor needed : hbar/2 

  ! Calculating spin current operator : JS(n,m,alpha,s) = j^s_{nm,alpha}
  ! In Hamiltonian gauge - factor needed : 1/2
   do n=1,num_wann
     do m=1,num_wann
        do alpha=1,3
          do s=1,3

...
#endif
#endif
static void ATL_cJIK72x0x72TN2x1x72_a1_bX
 ...
 */
{
   ...
   const int incAk0 = ((incAk) / 72), incBk0 = ((incBk) / 72);
   #define incCm 4
   const int incCn = (((ldc) << 3)+((ldc) << 1)) - 144;
 ...
 */
   ...
   if (k=N-Nb)
      ATL_cJIK72x0x72TN2x1x72_a1_bX(72, k, 72, alpha, ca, lda, cb + (((Nb) << 6)+((Nb) << 3)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_cJIK72x0x72TN2x1x72_a1_b1
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=72, NB=0, KB=72, 
 * lda=72, ldb=72, ldc=0, mu=2, nu=1, ku=72, pf=0
 ...
 */
   ...
   if (k=N-Nb)
      ATL_cJIK72x0x72TN2x1x72_a1_b1(72, k, 72, alpha, ca, lda, cb + (((Nb) << 6)+((Nb) << 3)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif

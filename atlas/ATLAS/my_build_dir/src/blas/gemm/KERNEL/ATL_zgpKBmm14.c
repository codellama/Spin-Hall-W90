...
static void ATL_zJIK0x0x14TN1x1x14_a1_bX
 ...
 * lda=14, ldb=14, ldc=0, mu=1, nu=1, ku=14, pf=1
 ...
 */
   ...
   #undef Kb
#endif
void ATL_zJIK0x0x14TN14x14x0_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=14, 
 * lda=14, ldb=14, ldc=0, mu=10, nu=1, ku=14, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 14
   const int incAm = 126, incAn = -(14*(Mb));
   #define incBk 14
   const int incBm = -14, incBn = 14;
   const int incAk0 = ((incAk) / 14), incBk0 = ((incBk) / 14);
   #define incCm 20
 ...
 */
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x14TN1x1x14_a1_bX(k, N, 14, alpha, ca + (14*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif

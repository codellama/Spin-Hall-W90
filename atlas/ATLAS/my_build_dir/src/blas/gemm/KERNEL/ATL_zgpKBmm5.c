...
static void ATL_zJIK0x0x5TN1x1x5_a1_bX
 ...
 */
{
   ...
   #undef Kb
#endif
void ATL_zJIK0x0x5TN5x5x0_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=5, 
 * lda=5, ldb=5, ldc=0, mu=10, nu=1, ku=5, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 5
   const int incAm = 45, incAn = -(((Mb) << 2)+Mb);
   #define incBk 5
   const int incBm = -5, incBn = 5;
   #define incCm 20
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x5TN1x1x5_a1_bX(k, N, 5, alpha, ca + (((Mb) << 2)+Mb), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif

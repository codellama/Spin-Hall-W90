...
static void ATL_zJIK0x0x19TN1x1x19_a1_bX
 ...
 * lda=19, ldb=19, ldc=0, mu=1, nu=1, ku=19, pf=1
 ...
 */
   ...
   #undef Kb
#endif
void ATL_zJIK0x0x19TN19x19x0_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=19, 
 * lda=19, ldb=19, ldc=0, mu=10, nu=1, ku=19, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 19
   const int incAm = 171, incAn = -(19*(Mb));
   #define incBk 19
   const int incBm = -19, incBn = 19;
   const int incAk0 = ((incAk) / 19), incBk0 = ((incBk) / 19);
   #define incCm 20
 ...
 */
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x19TN1x1x19_a1_bX(k, N, 19, alpha, ca + (19*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif

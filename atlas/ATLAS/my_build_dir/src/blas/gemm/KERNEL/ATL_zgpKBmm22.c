...
static void ATL_zJIK0x0x22TN1x1x22_a1_bX
 ...
 * lda=22, ldb=22, ldc=0, mu=1, nu=1, ku=22, pf=1
 ...
 */
   ...
   #undef Kb
#endif
void ATL_zJIK0x0x22TN22x22x0_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=22, 
 * lda=22, ldb=22, ldc=0, mu=10, nu=1, ku=22, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 22
   const int incAm = 198, incAn = -(22*(Mb));
   #define incBk 22
   const int incBm = -22, incBn = 22;
   const int incAk0 = ((incAk) / 22), incBk0 = ((incBk) / 22);
   #define incCm 20
 ...
 */
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x22TN1x1x22_a1_bX(k, N, 22, alpha, ca + (22*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif

...
#endif
#endif
static void ATL_sJIK68x3x68TT2x3x4_a1_b1
 ...
 */
   ...
   #undef Kb
#endif
void ATL_sJIK68x68x68TT0x0x0_a1_b1
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 ...
 */
   ...
   while(pB0 != stN);
   ATL_sJIK68x3x68TT2x3x4_a1_b1(68, 3, 68, alpha, ca, lda, cb + 65, ldb, beta, cc + (((ldc) << 6)+ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif

...
#endif
#endif
static void ATL_sJIK68x3x68NT2x3x1_aX_b0
...
/*
 *    Peel first 1 iterations for C assignment
 */
      rC0_0 = m0;
      m0 = rA0 * rB1;
      rC1_0 = m1;
 ...
 */
      for (k=0; k < 66; k++) /* easy loop to unroll */
      {
         rC0_0 += m0;
         m0 = rA0 * rB1;
         rC1_0 += m1;
 ...
 */
   ...
   #undef Kb
#endif
void ATL_sJIK68x68x68NT0x0x0_aX_b0
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 ...
 */
   ...
   while(pB0 != stN);
   ATL_sJIK68x3x68NT2x3x1_aX_b0(68, 3, 68, alpha, ca, lda, cb + 65, ldb, beta, cc + (((ldc) << 6)+ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif

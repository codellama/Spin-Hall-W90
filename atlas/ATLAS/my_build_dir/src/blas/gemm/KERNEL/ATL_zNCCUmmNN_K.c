...
static void ATL_zJIK0x0x40NN1x1x4_aX_bX
 ...
 */
{
   ...
   #undef Kb
#endif
void ATL_zJIK0x0x40NN0x0x0_aX_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=N, TB=N, MB=0, NB=0, KB=40, 
 ...
 */
{
   ...
   const double BetaAlpha = beta / alpha;
   const int incAk = (((lda) << 1));
   const int incAm = 20 - (((lda) << 6)+((lda) << 4)), incAn = -(((Mb) << 1));
   #define incBk 8
   const int incBm = -80, incBn = (((ldb) << 1));
   #define incCm 20
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x40NN1x1x4_aX_bX(k, N, 40, alpha, ca + (((Mb) << 1)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif

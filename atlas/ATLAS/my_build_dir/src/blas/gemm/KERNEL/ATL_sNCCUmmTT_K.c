...
#endif
#endif
static void ATL_sJIK0x0x68TT1x1x4_aX_bX
...
/*
 * matmul with TA=T, TB=T, MB=0, NB=0, KB=68, 
 ...
 */
   ...
   #undef Kb
#endif
static void ATL_sJIK0x0x68TT2x1x4_aX_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=T, MB=0, NB=0, KB=68, 
 ...
 */
   ...
   if (k=M-Mb)
      ATL_sJIK0x0x68TT1x1x4_aX_bX(k, N, 68, alpha, ca + (Mb*lda), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_sJIK0x0x68TT1x5x4_aX_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=T, MB=0, NB=0, KB=68, 
 ...
 */
   ...
   if (k=N-Nb)
      ATL_sJIK0x0x68TT1x1x4_aX_bX(M, k, 68, alpha, ca, lda, cb + (Nb), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif
   ...
   #undef Kb
#endif
void ATL_sJIK0x0x68TT0x0x0_aX_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=T, MB=0, NB=0, KB=68, 
 ...
 */
   ...
   if (k=N-Nb)
      ATL_sJIK0x0x68TT2x1x4_aX_bX(M, k, 68, alpha, ca, lda, cb + (Nb), ldb, beta, cc + (Nb*ldc), ldc);
   if (Nb && (k=M-Mb))
      ATL_sJIK0x0x68TT1x5x4_aX_bX(k, Nb, 68, alpha, ca + (Mb*lda), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif

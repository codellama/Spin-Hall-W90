...
static void ATL_zJIK0x0x8TN1x1x8_a1_bX
 ...
 */
{
   ...
   #undef Kb
#endif
void ATL_zJIK0x0x8TN8x8x0_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=8, 
 * lda=8, ldb=8, ldc=0, mu=10, nu=1, ku=8, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x8TN1x1x8_a1_bX(k, N, 8, alpha, ca + (((Mb) << 3)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif

...
{ \
   ...
   ATL_zupMBmm0_2_0_bX(M_, N_, K_, al_, A_, lda_, (B_)+(ldb_)*(N_), ldb_, be_, (C_)+1, ldc_); \
...
#define ATL_ZupMBmm0_4_0_bX(M_, N_, K_, al_, A_, lda_, B_, ldb_, be_, C_, ldc_) \
{ \
   ATL_zupMBmm0_4_0_bX(M_, N_, K_, al_, A_, lda_, B_, ldb_, -(be_), C_, ldc_); \
   ATL_zupMBmm0_4_0_bX(M_, N_, K_, al_, A_, lda_, (B_)+(ldb_)*(N_), ldb_, be_, (C_)+1, ldc_); \

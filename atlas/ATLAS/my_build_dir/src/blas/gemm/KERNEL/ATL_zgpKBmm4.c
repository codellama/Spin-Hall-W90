...
static void ATL_zJIK0x0x4TN1x1x4_a1_bX
 ...
 * lda=4, ldb=4, ldc=0, mu=1, nu=1, ku=4, pf=1
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=4, 
 * lda=4, ldb=4, ldc=0, mu=10, nu=1, ku=4, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x4TN1x1x4_a1_bX(k, N, 4, alpha, ca + (((Mb) << 2)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif

...
static void ATL_CupMBmm0_10_0_b1
   (const int M, const int N, const int K, const float alpha,
    const float *A, const int lda, const float *B, const int ldb,
    const float beta, float *C, const int ldc)
{
   const float *rA = A + lda*M, *rB = B + ldb*N;
   ATL_cupMBmm0_10_0_bX(M, N, K, alpha, A, lda, B, ldb, ATL_rnone, C, ldc); 
   ATL_cupMBmm0_10_0_b1(M, N, K, alpha, A, lda, rB, ldb, beta, C+1, ldc); 
...
static void ATL_CupMBmm0_6_0_b1
   (const int M, const int N, const int K, const float alpha,
    const float *A, const int lda, const float *B, const int ldb,
    const float beta, float *C, const int ldc)
{
   const float *rA = A + lda*M, *rB = B + ldb*N;
   ATL_cupMBmm0_6_0_bX(M, N, K, alpha, A, lda, B, ldb, ATL_rnone, C, ldc); 
   ATL_cupMBmm0_6_0_b1(M, N, K, alpha, A, lda, rB, ldb, beta, C+1, ldc); 
...
static void ATL_CupMBmm0_4_0_b1
   (const int M, const int N, const int K, const float alpha,
    const float *A, const int lda, const float *B, const int ldb,
    const float beta, float *C, const int ldc)
{
   const float *rA = A + lda*M, *rB = B + ldb*N;
   ATL_cupMBmm0_4_0_bX(M, N, K, alpha, A, lda, B, ldb, ATL_rnone, C, ldc); 
   ATL_cupMBmm0_4_0_b1(M, N, K, alpha, A, lda, rB, ldb, beta, C+1, ldc); 
...
static void ATL_CupMBmm0_2_0_b1
   (const int M, const int N, const int K, const float alpha,
    const float *A, const int lda, const float *B, const int ldb,
    const float beta, float *C, const int ldc)
{
   const float *rA = A + lda*M, *rB = B + ldb*N;
   ATL_cupMBmm0_2_0_bX(M, N, K, alpha, A, lda, B, ldb, ATL_rnone, C, ldc); 
   ATL_cupMBmm0_2_0_b1(M, N, K, alpha, A, lda, rB, ldb, beta, C+1, ldc); 

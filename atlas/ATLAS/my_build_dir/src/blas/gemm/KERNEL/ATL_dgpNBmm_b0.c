#ifdef ATL_UCLEANN
#define ATL_dJIK52x0x52TN52x52x0_a1_b0 ATL_dgpNBmm_b0
#else
#define ATL_dJIK52x0x52TN52x52x0_a1_b0 ATL_dpNBmm_b0
#endif
...
#endif
#endif
static void ATL_dJIK52x0x52TN2x1x1_a1_b0
 ...
 */
   ...
   #undef Kb
#endif
void ATL_dJIK52x0x52TN52x52x0_a1_b0
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=52, NB=0, KB=52, 
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK52x0x52TN2x1x1_a1_b0(52, k, 52, alpha, ca, lda, cb + (52*(Nb)), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif

#ifdef ATL_UCLEANM
#define ATL_dJIK0x52x52TN52x52x0_a1_b0 ATL_dgpMBmm_b0
#else
#define ATL_dJIK0x52x52TN52x52x0_a1_b0 ATL_dpMBmm_b0
#endif
...
#endif
#endif
static void ATL_dJIK0x4x52TN1x4x1_a1_b0
 ...
 */
      for (k=0; k < 51; k++) /* easy loop to unroll */
      {
         rA0 = *pA0;
         rB0 = *pB0;
         rB1 = pB0[52];
   ...
   #undef Kb
#endif
static void ATL_dJIK0x4x52TN2x4x1_a1_b0
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=4, KB=52, 
 ...
 */
   ...
   if (k=M-Mb)
      ATL_dJIK0x4x52TN1x4x1_a1_b0(k, 4, 52, alpha, ca + (52*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_dJIK0x48x52TN1x6x1_a1_b0
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 ...
 */
   ...
   #undef Kb
#endif
void ATL_dJIK0x52x52TN52x52x0_a1_b0
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 ...
 */
   ...
   ATL_dJIK0x4x52TN2x4x1_a1_b0(M, 4, 52, alpha, ca, lda, cb + 2496, ldb, beta, cc + (((ldc) << 5)+((ldc) << 4)), ldc);
   if (k=M-Mb)
      ATL_dJIK0x48x52TN1x6x1_a1_b0(k, 48, 52, alpha, ca + (52*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif

...
#endif
#endif
static void ATL_sJIK72x0x72TN2x1x72_a1_b1
 ...
 */
   ...
   if (k=N-Nb)
      ATL_sJIK72x0x72TN2x1x72_a1_b1(72, k, 72, alpha, ca, lda, cb + (((Nb) << 6)+((Nb) << 3)), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif

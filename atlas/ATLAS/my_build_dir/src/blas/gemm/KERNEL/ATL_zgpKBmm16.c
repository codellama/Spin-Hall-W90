...
static void ATL_zJIK0x0x16TN1x1x16_a1_bX
 ...
 * lda=16, ldb=16, ldc=0, mu=1, nu=1, ku=16, pf=1
 ...
 */
   ...
   #undef Kb
#endif
void ATL_zJIK0x0x16TN16x16x0_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=16, 
 * lda=16, ldb=16, ldc=0, mu=10, nu=1, ku=16, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 16
   const int incAm = 144, incAn = -(((Mb) << 4));
   #define incBk 16
   const int incBm = -16, incBn = 16;
   const int incAk0 = ((incAk) >> 4), incBk0 = ((incBk) >> 4);
   #define incCm 20
 ...
 */
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x16TN1x1x16_a1_bX(k, N, 16, alpha, ca + (((Mb) << 4)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif

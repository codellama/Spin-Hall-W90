 ...
 */
   ...
   #undef Kb
#endif
static void ATL_sJIK0x0x58TN2x1x58_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=58, 
 * lda=58, ldb=58, ldc=0, mu=2, nu=1, ku=58, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   const int Mb = (M>>1)<<1;
   ...
   const float *stN = B + (58*(Nb));
   #define incAk 58
   const int incAm = 58, incAn = -(58*(Mb));
   #define incBk 58
   const int incBm = -58, incBn = 58;
   const int incAk0 = ((incAk) / 58), incBk0 = ((incBk) / 58);
   #define incCm 2
...
#endif
#endif
static void ATL_sJIK0x0x58TN1x5x58_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=58, 
 * lda=58, ldb=58, ldc=0, mu=1, nu=5, ku=58, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   #define Mb M
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=58, 
 * lda=58, ldb=58, ldc=0, mu=2, nu=5, ku=58, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   const int Mb = (M>>1)<<1;
 ...
 */
   ...
   if (k=N-Nb)
      ATL_sJIK0x0x58TN2x1x58_a1_bX(M, k, 58, alpha, ca, lda, cb + (58*(Nb)), ldb, beta, cc + (Nb*ldc), ldc);
   if (Nb && (k=M-Mb))
      ATL_sJIK0x0x58TN1x5x58_a1_bX(k, Nb, 58, alpha, ca + (58*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif

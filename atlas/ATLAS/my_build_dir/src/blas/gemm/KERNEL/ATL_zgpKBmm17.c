...
static void ATL_zJIK0x0x17TN1x1x17_a1_bX
 ...
 * lda=17, ldb=17, ldc=0, mu=1, nu=1, ku=17, pf=1
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=17, 
 * lda=17, ldb=17, ldc=0, mu=10, nu=1, ku=17, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 17
   const int incAm = 153, incAn = -(((Mb) << 4)+Mb);
   #define incBk 17
   const int incBm = -17, incBn = 17;
   const int incAk0 = ((incAk) / 17), incBk0 = ((incBk) / 17);
   #define incCm 20
 ...
 */
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x17TN1x1x17_a1_bX(k, N, 17, alpha, ca + (((Mb) << 4)+Mb), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif

...
static void ATL_zJIK0x0x11TN1x1x11_a1_bX
 ...
 */
   ...
   #undef Kb
#endif
void ATL_zJIK0x0x11TN11x11x0_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=11, 
 * lda=11, ldb=11, ldc=0, mu=10, nu=1, ku=11, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 11
   const int incAm = 99, incAn = -(11*(Mb));
   #define incBk 11
   const int incBm = -11, incBn = 11;
   const int incAk0 = ((incAk) / 11), incBk0 = ((incBk) / 11);
   #define incCm 20
 ...
 */
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x11TN1x1x11_a1_bX(k, N, 11, alpha, ca + (11*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif

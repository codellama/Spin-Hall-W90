#include "atlas_asm.h"
/*
 * This file does a 3x6 unrolled r1_sse with these params:
 *    CL=8, ORDER=clmajor
 */
 ...
 */
   ...
   LOOPN:
      ...
      LOOPM:
         ...
         movaps rY4, rA0   /* rA0 = {Y4i, Y4r,Y4i, Y4r} */
         mulps  rXr, rA0   /* rA0 = {X1r*Y4i,X1r*Y4r,X0r*Y4i,X0r*Y4r} */
         addps  128-128(pA0,lda,4), rA0
         movaps rYh4, ra0  /* ra0 = {Y4r,-Y4i,Y4r,-Y4i} */
         mulps  rXi, ra0   /* ra0 = {X1i*Y0r,-X1i*Y0i,X0i*Y0r,-X0i*Y0i} */
         addps  ra0, rA0
         MOVA   rA0, 128-128(pA0,lda,4)
         prefA(PFADIST+128(pA0,lda5))
         movaps rY5, rA0   /* rA0 = {Y5i, Y5r,Y5i, Y5r} */
         mulps  rXr, rA0   /* rA0 = {X1r*Y5i,X1r*Y5r,X0r*Y5i,X0r*Y5r} */
         addps  128-128(pA0,lda5), rA0
         movaps rYh5, ra0  /* ra0 = {Y5r,-Y5i,Y5r,-Y5i} */
         mulps  rXi, ra0   /* ra0 = {X1i*Y0r,-X1i*Y0i,X0i*Y0r,-X0i*Y0i} */
         addps  ra0, rA0
         MOVA   rA0, 128-128(pA0,lda5)
         ...
         movaps rY4, rA0   /* rA0 = {Y4i, Y4r,Y4i, Y4r} */
         mulps  rXr, rA0   /* rA0 = {X1r*Y4i,X1r*Y4r,X0r*Y4i,X0r*Y4r} */
         addps  144-128(pA0,lda,4), rA0
         movaps rYh4, ra0  /* ra0 = {Y4r,-Y4i,Y4r,-Y4i} */
         mulps  rXi, ra0   /* ra0 = {X1i*Y0r,-X1i*Y0i,X0i*Y0r,-X0i*Y0i} */
         addps  ra0, rA0
         MOVA   rA0, 144-128(pA0,lda,4)
         movaps rY5, rA0   /* rA0 = {Y5i, Y5r,Y5i, Y5r} */
         mulps  rXr, rA0   /* rA0 = {X1r*Y5i,X1r*Y5r,X0r*Y5i,X0r*Y5r} */
         addps  144-128(pA0,lda5), rA0
         movaps rYh5, ra0  /* ra0 = {Y5r,-Y5i,Y5r,-Y5i} */
         mulps  rXi, ra0   /* ra0 = {X1i*Y0r,-X1i*Y0i,X0i*Y0r,-X0i*Y0i} */
         addps  ra0, rA0
         MOVA   rA0, 144-128(pA0,lda5)

         movsldup 160-128(pX), rXr /* rXr = { X1r, X1r, X0r, X0r} */
         movaps rY0, rA0   /* rA0 = {Y0i, Y0r,Y0i, Y0r} */
         mulps  rXr, rA0   /* rA0 = {X1r*Y0i,X1r*Y0r,X0r*Y0i,X0r*Y0r} */
         addps  160-128(pA0), rA0
         ...
         movaps rY4, rA0   /* rA0 = {Y4i, Y4r,Y4i, Y4r} */
         mulps  rXr, rA0   /* rA0 = {X1r*Y4i,X1r*Y4r,X0r*Y4i,X0r*Y4r} */
         addps  160-128(pA0,lda,4), rA0
         movaps rYh4, ra0  /* ra0 = {Y4r,-Y4i,Y4r,-Y4i} */
         mulps  rXi, ra0   /* ra0 = {X1i*Y0r,-X1i*Y0i,X0i*Y0r,-X0i*Y0i} */
         addps  ra0, rA0
         MOVA   rA0, 160-128(pA0,lda,4)
         movaps rY5, rA0   /* rA0 = {Y5i, Y5r,Y5i, Y5r} */
         mulps  rXr, rA0   /* rA0 = {X1r*Y5i,X1r*Y5r,X0r*Y5i,X0r*Y5r} */
         addps  160-128(pA0,lda5), rA0
         movaps rYh5, ra0  /* ra0 = {Y5r,-Y5i,Y5r,-Y5i} */
         mulps  rXi, ra0   /* ra0 = {X1i*Y0r,-X1i*Y0i,X0i*Y0r,-X0i*Y0i} */
         addps  ra0, rA0
         MOVA   rA0, 160-128(pA0,lda5)

         movsldup 176-128(pX), rXr /* rXr = { X1r, X1r, X0r, X0r} */
         movaps rY0, rA0   /* rA0 = {Y0i, Y0r,Y0i, Y0r} */
         mulps  rXr, rA0   /* rA0 = {X1r*Y0i,X1r*Y0r,X0r*Y0i,X0r*Y0r} */
         addps  176-128(pA0), rA0
         ...
         movaps rY4, rA0   /* rA0 = {Y4i, Y4r,Y4i, Y4r} */
         mulps  rXr, rA0   /* rA0 = {X1r*Y4i,X1r*Y4r,X0r*Y4i,X0r*Y4r} */
         addps  176-128(pA0,lda,4), rA0
         movaps rYh4, ra0  /* ra0 = {Y4r,-Y4i,Y4r,-Y4i} */
         mulps  rXi, ra0   /* ra0 = {X1i*Y0r,-X1i*Y0i,X0i*Y0r,-X0i*Y0i} */
         addps  ra0, rA0
         MOVA   rA0, 176-128(pA0,lda,4)
         movaps rY5, rA0   /* rA0 = {Y5i, Y5r,Y5i, Y5r} */
         mulps  rXr, rA0   /* rA0 = {X1r*Y5i,X1r*Y5r,X0r*Y5i,X0r*Y5r} */
         addps  176-128(pA0,lda5), rA0
         movaps rYh5, ra0  /* ra0 = {Y5r,-Y5i,Y5r,-Y5i} */
         mulps  rXi, ra0   /* ra0 = {X1i*Y0r,-X1i*Y0i,X0i*Y0r,-X0i*Y0i} */
         addps  ra0, rA0
         MOVA   rA0, 176-128(pA0,lda5)
